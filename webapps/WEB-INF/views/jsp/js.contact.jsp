...
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.themepunch.tools.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.themepunch.revolution.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.themepunch.showbizpro.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.flexslider-min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/chosen.jquery.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.magnific-popup.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/waypoints.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="newscripts/scripts/jquery.counterup.min.js"/>"></script>
		...
		<div class="container">
			<div class="sixteen columns">
				...
				<ul class="responsive float-right">
					...
					<li><a href="<%=request.getContextPath()%>/jobseeker/jsEditAccounts?username=${username}">Account</a></li>
...
<script defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCNt8kl2xEcFMhE620rzqQ1x6n2QbwoXPY"
  type="text/javascript"/></script>
