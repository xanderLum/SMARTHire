...
================================================== -->
		...
		<div class="container">
			<div class="sixteen columns">
				...
				<div id="logo">
					<h1>
						<a href="index.jsp"><img src="images/smartlogo.png"
							alt="SMARTHire" /></a>
					</h1>
				</div>
				...
				<ul id="responsive">
					...
					<li><a href="blog.jsp" id="current">Blog</a></li>
				</ul>


				<ul class="responsive float-right">
					<li><a href="my-account.jsp#tab2"><i class="fa fa-user"></i>
							Sign Up</a></li>
					<li><a href="my-account.jsp"><i class="fa fa-lock"></i>
							Log In</a></li>
				</ul>
		...
		<div class="container">
			...
			<div class="eleven columns">
				<div class="padding-right">
					...
					<div class="post-container">
						...
						<div class="post-content">
							...
							<div class="post-quote">
								...
								<blockquote>Mauris aliquet ultricies ante, non
									faucibus ante gravida sed. Sed ultrices pellentesque purus,
									vulputate volutpat ipsum hendrerit sed neque sed sapien rutrum.
								</blockquote>
							</div>

							<p>In ut odio libero, at vulputate urna. Nulla tristique mi a
								massa convallis cursus. Nulla eu mi magna. Etiam suscipit
								commodo gravida. Cras suscipit, quam vitae adipiscing faucibus,
								risus nibh laoreet odio, a porttitor metus eros ut enim. Morbi
								augue velit, tempus mattis dignissim nec, porta sed risus. Donec
								eget magna eu lorem tristique pellentesque eget eu dui. Fusce
								lacinia tempor malesuada. Ut lacus sapien, placerat a ornare
								nec, elementum sit amet felis. Maecenas pretium lorem hendrerit
								eros sagittis fermentum.</p>
							<p class="margin-reset">Phasellus enim magna, varius et
								commodo ut, ultricies vitae velit. Ut nulla tellus, eleifend
								euismod pellentesque vel, sagittis vel justo. In libero urna,
								venenatis sit amet ornare non, suscipit nec risus. Sed consequat
								justo non mauris pretium at tempor justo sodales. Quisque
								tincidunt laoreet malesuada. Cum sociis natoque penatibus et
								magnis dis parturient montes, nascetur ridiculus mus. Integer
								vitae ante enim. Fusce sed elit est. Suspendisse sit amet mauris
								in quam pretium faucibus et aliquam odio.</p>
					...
					<h4>
						Comments <span class="comments-amount">(4)</span>
					</h4>
					...
					<ul>
						<li>
							...
							<div class="comment-content">
								...
								<div class="comment-by">
									Kathy Brown<span class="date">12th, June 2015</span> <a
						...
						<li>
							...
							<div class="comment-content">
								<div class="arrow-comment"></div>
								<div class="comment-by">
									John Doe<span class="date">15th, May 2015</span> <a href="#"
					...
					<form id="add-comment" class="add-comment">
						<fieldset>
							...
							<div>
								<label>Email: <span>*</span></label> <input type="text" value="" />
							</div>
						...
						<div class="tab-content" id="tab1">
							...
							<ul class="widget-tabs">
								...
								<li>
									<div class="widget-thumb">
										<a href="blog-single-post.html"><img
											src="images/blog-widget-01.png" alt="" /></a>
									</div>
								...
								<li>
									<div class="widget-thumb">
										<a href="blog-single-post.html"><img
											src="images/blog-widget-02.png" alt="" /></a>
									</div>
								...
								<li>
									<div class="widget-thumb">
										<a href="blog-single-post.html"><img
											src="images/blog-widget-03.png" alt="" /></a>
									</div>
